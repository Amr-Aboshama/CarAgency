namespace Car_Agency
{
    partial class userSalesMan
    {
        ...
        private void InitializeComponent()
        {
			...
			this.CustTile.Style = MetroFramework.MetroColorStyle.Red;
			...
			this.CarsTile.Style = MetroFramework.MetroColorStyle.Red;
			...
			this.ReqTile.Style = MetroFramework.MetroColorStyle.Red;
			...
			this.CatmetroTile1.Style = MetroFramework.MetroColorStyle.Red;
			...
			this.Name = "userSalesMan";
			this.Style = MetroFramework.MetroColorStyle.Red;
			this.Text = "Salesman";
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.userSalesMan_FormClosed);
			this.Load += new System.EventHandler(this.userSalesMan_Load);
