namespace Car_Agency
{
	partial class TreasuryManager
	{
		...
		private void InitializeComponent()
		{
			...
			this.metroButton2.Text = "Safe Status";
			this.metroButton2.UseSelectable = true;
			this.metroButton2.Click += new System.EventHandler(this.metroButton2_Click);
			// 
			// metroButton3
			// 
			this.metroButton3.Location = new System.Drawing.Point(23, 323);
			...
			// metroButton4
			// 
			this.metroButton4.Location = new System.Drawing.Point(23, 258);
			this.metroButton4.Name = "metroButton4";
			this.metroButton4.Size = new System.Drawing.Size(565, 59);
			this.metroButton4.TabIndex = 2;
			this.metroButton4.Text = "Add New Supplier";
			this.metroButton4.UseSelectable = true;
			this.metroButton4.Click += new System.EventHandler(this.metroButton4_Click);
			// 
			// metroButton5
			// 
			this.metroButton5.Location = new System.Drawing.Point(23, 193);
			this.metroButton5.Name = "metroButton5";
			this.metroButton5.Size = new System.Drawing.Size(565, 59);
			this.metroButton5.TabIndex = 4;
			this.metroButton5.Text = "Suppliers";
